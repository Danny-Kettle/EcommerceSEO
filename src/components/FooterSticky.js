...
const FooterSticky = () => {
  return (
    <footer className="absolute bottom-0 w-full bg-gray-900 h-40 text-white p-6">
      <div className="container mx-auto flex flex-wrap justify-between">
        ...
        <div className="flex items-center justify-center  flex-1">
          <p className="text-sm font-bold">&copy; 2023 Danny Kettle</p>
        </div>
        <div className="flex items-center justify-center flex-1">
          <ul className="list-none">
            <li>
              <Link href="/">
                <p className="text-gray-400 hover:text-white hover:underline mx-3">
                  Home
                </p>
              </Link>
            </li>
